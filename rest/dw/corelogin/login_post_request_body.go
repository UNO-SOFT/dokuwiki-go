...
// GetPass gets the pass property value. The password
// returns a *string when successful
func (m *LoginPostRequestBody) GetPass()(*string) {
    return m.pass
}
// GetUser gets the user property value. The user name
// returns a *string when successful
...
// SetPass sets the pass property value. The password
func (m *LoginPostRequestBody) SetPass(value *string)() {
    m.pass = value
}
// SetUser sets the user property value. The user name
